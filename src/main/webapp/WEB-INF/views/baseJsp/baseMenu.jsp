...
<div class="sidebarmenu">
    <a class="menuitem submenuheader" href="rest/index">主页</a>
    <div class="submenu">
        <ul>
            <li><a href="rest/index">超级管理员主页</a></li>
            <li><a href="rest/user/info_check">地区管理员主页</a></li>
            <li><a href="rest/user/info_check">教师 主页</a></li>
            <li><a href="rest/user/info_check">学生主页</a></li>
