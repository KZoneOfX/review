...
EDiaryEditor = {
    ...
    initView: function (sParentID) {
        ...
        var _toolbarStr = "\
			<div id='EDiaryEditor'style='width: 621px;'>\
				<div id='EDiaryEditorToolBar' style='position: relative; width: 621px; height: 69px; background-image: url(images/editor/toolbar_bg.gif);'>\
					<div id='EDiaryEditorFontFamilyMenu' title='����' style='position: absolute; left: 80px; top: 12px; width: 92px; height: 18px; line-height: 20px; padding-left: 4px; cursor: pointer;' action='Family' unselectable='on'>����</div>\
					<div id='EDiaryEditorFontSizeMenu' title='�ֺ�' style='position: absolute; left: 177px; top: 12px; width: 66px; height: 18px; line-height: 20px; padding-left: 4px; cursor: pointer;' action='Size' unselectable='on'>�ֺ�</div>\
					<div id='EDiaryEditorFontStyleMenu' title='����' style='position: absolute; left: 245px; top: 12px; width: 66px; height: 18px; line-height: 20px; padding-left: 4px; cursor: pointer;' action='Style' unselectable='on'>����</div>\
				</div>\
				...
				<div style='width: 621px; height: 59px; background-image: url(images/editor/editor_foot.gif)'>\
					<div style='float: left; padding-top: 18px; margin-left: 18px; margin-top: 16px;'><input type='checkbox' id='ModeCheck'><label for='ModeCheck'>��ʾԴ����</label></div>\
				</div>\
			</div>\
		";
        ...
        var _toolBarInfo = [
            {l: 11, t: 12, w: 35, h: 51, a: "ճ��", n: "paste"},
            {l: 46, t: 12, w: 21, h: 24, a: "����", n: "cut"},
            {l: 46, t: 36, w: 21, h: 27, a: "����", n: "copy"},
            {l: 77, t: 41, w: 23, h: 23, a: "����", n: "undo"},
            {l: 102, t: 41, w: 23, h: 23, a: "����", n: "redo"},
            {l: 133, t: 41, w: 23, h: 23, a: "����", n: "bold"},
            {l: 158, t: 41, w: 24, h: 23, a: "б��", n: "italic"},
            {l: 184, t: 41, w: 24, h: 23, a: "�»���", n: "underline"},
            {l: 210, t: 41, w: 24, h: 23, a: "������ɫ", n: "forecolor", c: "FColor"},
            {l: 236, t: 41, w: 24, h: 23, a: "������ɫ", n: "hilitecolor", c: "HColor"},
            {l: 262, t: 41, w: 24, h: 23, a: "����", n: "inserthorizontalrule"},
            {l: 288, t: 41, w: 24, h: 23, a: "�������", n: "face", c: "FaceBG"},
            {l: 320, t: 41, w: 23, h: 23, a: "�����", n: "justifyleft"},
            {l: 345, t: 41, w: 24, h: 23, a: "���ж���", n: "justifycenter"},
            {l: 371, t: 41, w: 24, h: 23, a: "�Ҷ���", n: "justifyright"},
            {l: 397, t: 41, w: 24, h: 23, a: "���˶���", n: "justifyfull"},
            {l: 429, t: 41, w: 59, h: 23, a: "ͼƬ�Ű�", n: "justifyformat", c: "Justify"},
            {l: 320, t: 10, w: 23, h: 23, a: "���", n: "insertorderedlist"},
            {l: 345, t: 10, w: 24, h: 23, a: "��Ŀ����", n: "insertunorderedlist"},
            {l: 371, t: 10, w: 24, h: 23, a: "��������", n: "outdent"},
            {l: 397, t: 10, w: 24, h: 23, a: "��������", n: "indent"},
            {l: 429, t: 10, w: 23, h: 23, a: "����ͼƬ", n: "img"},
            {l: 454, t: 10, w: 24, h: 23, a: "��������", n: "link"},
            {l: 480, t: 10, w: 24, h: 23, a: "������", n: "table"},
            {l: 531, t: 10, w: 24, h: 23, a: "��������", n: "iask"},
            {l: 506, t: 10, w: 23, h: 23, a: "�����ı���", n: "textarea"},
            {l: 496, t: 41, w: 59, h: 23, a: "Ԥ������", n: "view"},
            {l: 563, t: 10, w: 48, h: 54, a: "���仯", n: "ParaFormatting"},
        ];
                    ...
                    if (key2 == 0) {// head
                        _toolbarStr3 += "\
							...
							<div style='cursor: default; position: absolute; width: 163px; top: 32px; left: 78px; display: none;' id='EDiaryEditorFontFamilyItem'>\
								<div style='text-align: center; height: 20px; background-image: url(images/editor/menu_title.gif); padding-top: 6px; padding-left: 6px;'><b>����</b></div>\
                    ...
                    if (key2 == 0) {// head
                        _toolbarStr3 += "\
							...
							<div style='cursor: default; position: absolute; width: 163px; top: 32px; left: 175px; display: none;' id='EDiaryEditorFontSizeItem'>\
								<div style='text-align: center; height: 20px; background-image: url(images/editor/menu_title.gif); padding-top: 6px; padding-left: 6px;'><b>�ֺ�</b></div>\
        ...
        if (window._isIE) {
            ...
            function EDiaryEditorRsave() {
                try {
                    ...
                    if (oData != null && oData != "") {
                        if (confirm("����һƪδ��ɵ����ݣ��Ƿ�ȷ�ϻָ���")) {
                            if (_this.iframe.style.display != "none") {// ���ģʽ
        ...
        if (CMD == "" || CMD == null)return;
            ...
            for (var i = 0; i < oChild.length; i++) {
                if (oChild[i].tagName) {
                    ...
                    // �Ƿ��Ѿ��Ź���,ʹ�� 2em ��ʹ�����Ű���ң�h1,h2���,�����Ĭ�� 28 ���ء�ͨ�������ӽڵ� fontSize ��ʽͬ���д�����
                    ...
                    oBody.innerHTML = '<div style="text-indent:2em;">' + oBody.innerHTML.replace(/(^[ |��]*)|([ |��]*$)/g, "");
                    +'</div>';
                }
            }
        }
